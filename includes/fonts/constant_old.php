...
define('CONTACT_EMAIL_ID', 'info@balance-withus.com');
...
define('FREE_TRIAL_SUBSCRIPTION_ID', '5');
define('FREE_7_DAYS_TRIAL_SUBSCRIPTION_ID', '6');
define('FREE_MONTHLY_MEMBERSHIP_SUBSCRIPTION_ID', '4');

define('ACTIVATE_FREE_TRIAL_APPLICABLE_DATE', '2020-07-20 00:00:00');

define('STRIPE_CLIENT_ID', 'ca_EPB9SUFyNsLAIVxYxvzT0rGlYdrbhwF7');
...
define('STANDERD_INSUB_ID',2);
define('VOD_INDIVIDUAL_INSUB_ID',4);
...
define('FAQ_INSTRUCTOR_LANDING',7);

define('ZOOM_OAUTH_CLIENT_ID','3mXbTalbQEqGNaDxZkp1g');
define('ZOOM_OAUTH_CLIENT_SECRET','Hv39gr1r46DyEIclwo5B5F2cVuIRUnvG');
define('ZOOM_REDIRECT_URL','https://www.balance-withus.com/zoom-test/redirect');

define('AFFILIATE_PAYOUT_DURATION','90');

//S3 Bucket folders
define('S3_VOD_FOLDER','vod');
define('S3_GALLERY_FOLDER', 'gallery/');
define('S3_GALLERY_THUMB_FOLDER', 'gallery/thumb/');
define('S3_AWS_URL','https://balance-app.s3.ap-south-1.amazonaws.com');