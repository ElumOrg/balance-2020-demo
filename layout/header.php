...
<html lang="en">
   <head>
      ...
      <script>
        ...
        })(window,document,'script','dataLayer','GTM-PDG56HX');
      </script>
      ...
      'https://connect.facebook.net/en_US/fbevents.js');
       fbq('init', '935836866819184'); 
      fbq('track', 'PageView');
      </script>
      <noscript>
       <img height="1" width="1" src="https://www.facebook.com/tr?id=935836866819184&ev=PageView&noscript=1"/>
      </noscript>
    ...
    <body>
     ...
     <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PDG56HX" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
            ...
            <div class="container">
               ...
               <nav>
                  <ul>
                       ...
                       <li><a href="classes.php"  class="">Classes</a></li>
                       <li><a href="vod.php" class="">Video on Demand</a></li>
                       <li><a href="private-session.php"  class="">Private Sessions</a></li>
                       <li><a href="pricing.php"  class="">Pricing</a></li>
                       <!-- <li><a href="promotions.php"  class="">Promotions</a></li> -->
                       <li class="sub-menu">
                        <a href="#" class="">More</a>
                        <ul>
